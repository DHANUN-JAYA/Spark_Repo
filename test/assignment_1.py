import unittest
from Spark_Repo.src.Assignment_1.utils import *
import pyspark
...
class MyTestCase(unittest.TestCase):
    ...
    def test_something(self):
        ...
        act_location_df = count_unique_locations(transformdata_df)
        ...
        act_product_df = products_bought(transformdata_df)
        ...
        act_total_df = total_spending(transformdata_df)
